  ...
  return (
    <div className='w-full h-[400px] flex flex-col justify-center items-center gap-10'>
      <h1 className='font-bold text-[18px]'>
        Enter your email to receive daily weather forecast information at 7AM
      </h1>
      <div className='relative'>
        <input
          type='text'
          className={`max-md:w-[150px] w-[400px] p-5 rounded-md border-solid border-[2px] border-gray-300 outline-none`}
          value={email}
